<template>
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="bg-gray-200 w-48 h-screen border-r-2 pl-6 border-gray-400">
                <nav class="pt-4">
                    <router-link to="/">
                        <svg class="fill-current text-blue-600 w-16 h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <router-link :to="{name: 'Birthdays'}" class=" text-sm flex items-center gap-2 py-2 hover:text-blue-600">
            ...
            <div class="flex flex-col flex-1 h-screen overflow-y-auto">
                <div class="flex justify-between h-16 px-6 border-b-2 bordr-gray-400 items-center ">

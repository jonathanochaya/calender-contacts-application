...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 rounded-lg shadow-xl p-6" style="background-color: #2b3c65">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                <label for="email" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-2">E-mail</label>

                <div class="col-md-6">
                    <input id="email" placeholder="your@email.com" type="email" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
            ...
            <div class="relative pt-4">
                <label for="password" class="uppercase text-blue-500 text-xs font-bold absolute pl-2 pt-2">Password</label>

                <div class="col-md-6">
                    <input id="password" placeholder="Password" type="password" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400" name="password" autocomplete="current-password">
            ...
            <div class="pt-2">
                ...
                <label class="text-white pl-1" for="remember">Remember me</label>
            </div>

            <div class="pt-8">
                <button type="submit" class="w-full bg-gray-200 py-2 px-3 text-left text-blue-500 font-bold uppercase rounded">Login</button>
            </div>

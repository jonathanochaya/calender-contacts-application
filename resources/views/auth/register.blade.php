...
@section('content')
    <div class="bg-gray-300 mx-auto h-full flex justify-center items-center">
        <div class="w-96 p-6 rounded-lg shadow-xl" style="background-color: #2b3c65">
            ...
            <form method="POST" action="{{ route('register') }}" class="pt-8">
                ...
                <div class="relative">
                    ...
                    <input id="name" type="text" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Your Name">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="email" type="email" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="your@email.com">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password" type="password" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400 @error('password') border border-red-600 @enderror" name="password" required autocomplete="current-password" placeholder="Password">
                ...
                <div class="relative pt-3">
                    ...
                    <input id="password-confirm" type="password" class="outline-none focus:bg-blue-300 text-gray-300 pt-8 w-full rounded p-3 bg-blue-400" name="password_confirmation" required placeholder="Confirm">
                </div>
